...
public class AdminRegActivity extends AppCompatActivity {
        ...
        mRegBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (email.isEmpty() && password.isEmpty()){
                    Toast.makeText(AdminRegActivity.this,"email or pass empty",
                            Toast.LENGTH_LONG).show();
                }else{
                    mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(AdminRegActivity.this, new OnCompleteListener<AuthResult>() {
                        @Override
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if(!task.isSuccessful()){
                                Toast.makeText(AdminRegActivity.this, "error signing up", Toast.LENGTH_LONG).show();
                            }else{
                                String userId= mAuth.getCurrentUser().getUid();

                                DatabaseReference currentUid = FirebaseDatabase.getInstance().getReference().child("Admin").child(userId);
    ...
    public void logIn(View view) {
        Intent intent = new Intent(AdminRegActivity.this, AdminLoginActivity.class);
